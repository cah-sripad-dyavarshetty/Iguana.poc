...
function header_compare(csos_order_header_data,customer_billto_shipto_data,i)
    ...
    then  --if 5  --csos_order_header_data and order_header data comparing
        ...
        order_details_check(i,csos_order_header_data,order_details_data)  -- calling function after orde0details comparision done
...
function order_details_check(i,csos_order_header_data,order_details_data)
    ...
    if(#order_details_data>0) then  --if 6 --checking th size of order_details_data
        ...
        if(#prod_data>0) then -- if 13 prod_data
            ...
            if(#csos_order_details_data>0) then -- if 14 data from csos_order_details_data
                ...
                for_loop(csos_order_details_data,prod_data,order_details_data,csos_order_header_data,i)
...
function for_loop(csos_order_details_data,prod_data,order_details_data,csos_order_header_data,i)
    ...
    then  --if 8  -- checking the result of comparing
        ...
        if pcall(Soap_) then    --if 121
            ...
            if(status_result == true) then  --if 9  -- checking whether we got required result through soap
                ...
                Procedure(csos_order_header_data,i) -- calling function Procedure
        else
...
function Procedure(csos_order_header_datacsos_order_header_data,i)
